var colorOrder = ['teal', 'cyan', 'pink', 'amber', 'indigo', 'light-green', 'brown', 'orange', 'deep-purple', 'green', 'blue', 'red', 'yellow', 'green', 'purple'];
...
export function normalizeColor() {
    ...
    var _options$colors = options.colors,
        colors = _options$colors === undefined ? colorOrder : _options$colors,
        _options$level = options.level,
        level = _options$level === undefined ? 400 : _options$level,
    ...
    var color = materialColors[name + '-' + level] || materialColors[name] || name;
